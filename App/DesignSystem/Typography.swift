...
public extension View {
    func stratusTitle() -> some View {
        font(.stratusTitle)
    }

    func stratusHeadline() -> some View {
        font(.stratusHeadline)
    }

    func stratusBody() -> some View {
        font(.stratusBody)
    }

    func stratusCaption() -> some View {
        font(.stratusCaption).foregroundColor(.textSecondary)
    }

    func stratusMonospace() -> some View {
